...
export class CreateUserByAdminReqDTO {
    @ApiProperty()
    @IsNotEmpty()
    @IsEmail()
    email: string;
...
class CreateUserByAdminResDTOResData {
    @ApiProperty()
    id: number;
...
export class CreateUserResDTO {
    ...
    @ApiProperty({
        type: () => CreateUserByAdminResDTOResData,
        description: 'ข้อมูล',
    })
    resData: CreateUserByAdminResDTOResData;
    ...
    constructor(resCode: ResStatus, msg: string, datas: UserDB) {
        ...
        this.msg = msg;
        this.resData = new CreateUserByAdminResDTOResData();
        if (!!datas) {
